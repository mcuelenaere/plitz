...
class PhptTestCase implements \PHPUnit_Framework_Test, \PHPUnit_Framework_SelfDescribing
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($filename, array $settingsOverrides = [])
    {
        ...
        $this->settings = array_merge($this->settings, $settingsOverrides);
    }
